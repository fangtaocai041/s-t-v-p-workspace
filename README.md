...
coilia-agent/               �?P�?刀鲚专�?culter-agent/               �?P�?鲌类专研
conflict-arbiter/           �?C  冲突仲裁
infrastructure/             �?基础设施 (涌现检�?NLP/图像分类)
fishkb/                     �?独立鱼类知识�?(�?fish-ecology-assistant �?
...
# eon-core 健康检�?python eon-core/src/main.py --config eon-core/config/taiji.yaml health

# eon-core 路由测试
python eon-core/src/main.py --config eon-core/config/taiji.yaml route "长江江豚种群恢复"

# 标准管道
python -c "from eon-core.src.kernel.cross_project import CrossProjectPipeline; p=CrossProjectPipeline(); p.bootstrap(); print(p.run('�?, mode='standard').summary)"
```
...
| [项目关系文档](docs/PROJECT_RELATIONSHIPS.md) | 七项目包�?调用关系 |
...
| [方陶文库](方陶文库/) | 架构规范 + 生态学理论�?|
| [刘凯老师课题组](刘凯老师课题�?) | 课题组文献知识库 |
