"""Search 珠星三块鱼 via coordinated_search - direct."""
import sys, os, json
...
print("ENGINE_STATS:", json.dumps(d.get("engine_stats", {}), ensure_ascii=False, indent=2))
print()
print("TAXONOMY_WARNING:", d.get("taxonomy_warning"))
